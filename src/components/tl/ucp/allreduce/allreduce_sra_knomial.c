...
static ucc_status_t ucc_tl_ucp_allreduce_sra_knomial_setup_frag(
...
static ucc_status_t ucc_tl_ucp_allreduce_sra_knomial_init_frag(
                                      ...
                                      ucc_coll_task_t     **task_h)
{
    ...
    if (!schedule_p) {
        tl_error(team->context->lib, "failed to allocate schedule pipelined");
        return UCC_ERR_NO_MEMORY;
    }
    get_sra_n_frags(coll_args, tl_team, &n_frags, &pipeline_depth);
    ucc_schedule_pipelined_init(
        coll_args, team, ucc_tl_ucp_allreduce_sra_knomial_init_frag,
        ucc_tl_ucp_allreduce_sra_knomial_setup_frag, pipeline_depth, n_frags,
